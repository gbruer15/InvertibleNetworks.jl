...
function CouplingLayerBasic(n_in::Int64, n_hidden::Int64; k1=3, k2=3, p1=1, p2=1, s1=1, s2=1, logdet=false, activation::ActivationFunction=SigmoidLayer(), ndims=2, n_out=nothing)

    # 1x1 Convolution and residual block for invertible layer
    n_out = isnothing(n_out) ? 2*n_in : n_out
    RB = ResidualBlock(n_in, n_hidden; k1=k1, k2=k2, p1=p1, p2=p2, s1=s1, s2=s2, fan=true, ndims=ndims, n_out=n_out)
